...
# YOUR CODE HERE!
total_len = len(loan_costs)
print(f"total number loans is: {total_len}")
...
print(f"total sum of the loan is: {total_sum}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
avg_loan = total_sum / total_len
print(f"Avg loan is: {avg_loan}")
